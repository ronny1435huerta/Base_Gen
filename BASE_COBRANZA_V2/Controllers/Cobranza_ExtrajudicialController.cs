...
namespace BASE_COBRANZA_V2.Controllers
{
    ...
    public class Cobranza_ExtrajudicialController : Controller
    {
        ...
        public Cobranza_ExtrajudicialController() {
        ...
        public async Task<IActionResult> listar_cobranza(int p, int? Album)
        {
            int nr = 10;
            var base_gen = baseprocess.ListaBase();
            var stock_gen = stockprocess.ListaStock();
            var cobranza_gen = pasos_cobranzaprocess.ListaPasos_cobranza();
            int id_paso_cobranza = 0;
            foreach (var pasos in cobranza_gen)
            {
            ...
            ViewBag.cobranza = cobranza_gen;
            base_gen= base_gen.Where(p=>p.IdPasosCobranza!=id_paso_cobranza).ToList();
        ...
        public IActionResult Edit(int id) {
            ...
            if (base_general == null) return RedirectToAction("listar_cobranza", "Cobranza_Extrajudicial");
            //Si no es nulo
...
/*TODOS LOS STATUS DE COBRANZA, N*/
