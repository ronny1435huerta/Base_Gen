...
namespace BASE_COBRANZA_V2.Controllers
{
    ...
    public class Medidas_CautelaresController : Controller
    {
        ...
        public Medidas_CautelaresController()
        {
        ...
        public async Task<IActionResult> listar_mc(int p, int? Album)
        {
            int nr = 10;
            ...
            var lista_base = base_gen.Where(mc=>mc.IdPasosCobranza==id_paso_cobranza).ToList();
            var lista_mc = (
        ...
        public IActionResult Edit(int id)
        {
            ...
            if (base_general == null) return RedirectToAction("listar_mc", "Medidas_Cautelares");
            //Si no es nulo
        ...
        public IActionResult Edit(Base_Stock model)
        {
            ...
            return RedirectToAction("listar_mc", "Medidas_Cautelares");
...
/*Status del poder judicial: Consedido-falta ejecutar llena la lista de Expedientes por ejecutar
                             Concedido-oficiado llena la lista de Demanda principal
          Pasos de cobranza: COBRANZA EXTRAJUDICIAL FINALIZADA llena la lista de medidas cautelares si no tiene pagaré o si tiene de juicios arbitrales
tipo de solicitud de mc : retención, inscripción,secuestro, retención-inscripción, retención-secuestro,
                            inscripción-secuestro, retención-inscripción-secuestro ---> combo
respuesta de mc: retención, inscripción,secuestro, retención-inscripción, retención-secuestro,
                            inscripción-secuestro, retención-inscripción-secuestro ---> combo
 */
 ...
 * 
 nombre completo, dni, domicilio completo, placa del auto, fecha del contrato, pagaré, # expediente, distrito judicial, status de la demanda principal*/