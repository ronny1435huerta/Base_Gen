...
namespace BASE_COBRANZA_V2.Controllers
{
    ...
    public class Juicios_arbitralesController : Controller
    {
        ...
        public Juicios_arbitralesController()
        {
        ...
        public async Task<IActionResult> listar_ja(int p, int? Album)
        {
            int nr = 10;
            ...
            return View(await Task.Run(() => lista_ja.Skip(p * nr).Take(nr)));
        }
        [HttpGet]
        public IActionResult Edit(int id)
        {
            ...
            if (base_general == null) return RedirectToAction("listar_ja", "Juicios_arbitrales");
            //Si no es nulo
        ...
        public IActionResult Edit(Base_Stock model)
        {
            ...
            return RedirectToAction("listar_ja", "Juicios_arbitrales");
