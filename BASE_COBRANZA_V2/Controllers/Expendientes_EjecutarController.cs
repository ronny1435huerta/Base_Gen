...
namespace BASE_COBRANZA_V2.Controllers
{
    ...
    public class Expendientes_EjecutarController : Controller
    {
        ...
        public Expendientes_EjecutarController()
        {
        ...
        public async Task<IActionResult> listar_exej(int p, int? Album)
        {
            int nr = 10;
        ...
        public IActionResult Edit(int id)
        {
            ...
            if (base_general == null) return RedirectToAction("listar_exej", "Expendientes_Ejecutar");
            //Si no es nulo
        ...
        public IActionResult Edit(Base_Stock model)
        {
            ...
            return RedirectToAction("listar_exej", "Expendientes_Ejecutar");
